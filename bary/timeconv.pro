...
;
 ...
 yearleap = [1972, 1972, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980,$
             ...
             1996, 1997, 1999, 2006]
 monthleap = [1,7,1,1,1,1,1,1,1,1,7,7,7,7,1,1,1,7,7,7,1,7,1,1]   ;1=Jan, 7=July
 jdupdate = jdate([2006,1,1,0,0]) ; Date this file was last updated
...
;
     if not keyword_set(silent) and  jdUTC gt (4.*365.+JDupdate) then $;Too late
       Message,'Leap Second list has not been updated recently. Expect error of ~> 1 second.',/info
;
;
